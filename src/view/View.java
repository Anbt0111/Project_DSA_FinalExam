...
public class View extends JFrame {
    ...
    public static final String HIGH_SCORE_SCREEN = "highScore";
    ...
    public ActionController actionController = new ActionController(this);
    ...
    private void helpScreenInit() {
        ...
        this.add(helpScreen, HELP_SCREEN);
    }
    ...
    private void highScoreScreenInit() {
        ...
        this.add(highScoreScreen, HIGH_SCORE_SCREEN);
    }
